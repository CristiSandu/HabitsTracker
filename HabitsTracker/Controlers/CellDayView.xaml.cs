...
namespace HabitsTracker.Controlers;
...
public partial class CellDayView : ContentView
{
    ...
    public static readonly BindableProperty CommandParameterProperty = BindableProperty.Create(nameof(CommandParameter), typeof(object), typeof(CellDayView), null);
